 ...
 186  0019 9e            	ld	a,xh
 187  001a c75345        	ld	21317,a
 188                     ; 72   TIM4->ARR = (uint8_t)(TIM4_Period);
 190  001d 9f            	ld	a,xl
 191  001e c75346        	ld	21318,a
 192                     ; 73 }
 195  0021 81            	ret
 ...
 352  0035 9e            	ld	a,xh
 353  0036 ca5341        	or	a,21313
 354  0039 c75341        	ld	21313,a
 356  003c 2009          	jra	L351
 357  003e               L151:
 358                     ; 121     TIM4->IER &= (uint8_t)(~TIM4_IT);
 360  003e 7b01          	ld	a,(OFST+1,sp)
 361  0040 43            	cpl	a
 362  0041 c45341        	and	a,21313
 363  0044 c75341        	ld	21313,a
 364  0047               L351:
 365                     ; 123 }
 368  0047 85            	popw	x
 369  0048 81            	ret
 ...
 675  0073 9e            	ld	a,xh
 676  0074 c75345        	ld	21317,a
 677                     ; 225   TIM4->EGR = (uint8_t)TIM4_PSCReloadMode;
 679  0077 9f            	ld	a,xl
 680  0078 c75343        	ld	21315,a
 681                     ; 226 }
 684  007b 81            	ret
