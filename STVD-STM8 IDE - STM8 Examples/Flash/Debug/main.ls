 ...
 104                     ; 31 	LCD_putstr("STM8S Flash Test");
 106  0014 ae000c        	ldw	x,#L72
 107  0017 cd0000        	call	_LCD_putstr
 109                     ; 33 	value = FLASH_ReadByte(0x9FF0);
 111  001a ae9ff0        	ldw	x,#40944
 112  001d 89            	pushw	x
 ...
 179                     ; 48 			FLASH_Unlock(FLASH_MEMTYPE_PROG);
 181  0071 a6fd          	ld	a,#253
 182  0073 cd0000        	call	_FLASH_Unlock
 184                     ; 49 			FLASH_EraseByte(0x9FF0);
 186  0076 ae9ff0        	ldw	x,#40944
 187  0079 89            	pushw	x
 ...
 198                     ; 51 			FLASH_ProgramByte(0x9FF0, value);
 200  0089 7b01          	ld	a,(OFST+0,sp)
 201  008b 88            	push	a
 202  008c ae9ff0        	ldw	x,#40944
 203  008f 89            	pushw	x
 ...
 214                     ; 53 			FLASH_Lock(FLASH_MEMTYPE_PROG);
 216  009f a6fd          	ld	a,#253
 ...
 702  000c               L72:
 703  000c 53544d385320  	dc.b	"STM8S Flash Test",0
 704                     	xref.b	c_x
 724                     	xref	c_smodx
 725                     	xref	c_sdivx
 726                     	end
