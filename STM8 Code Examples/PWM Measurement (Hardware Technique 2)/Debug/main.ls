 ...
 504                     ; 109 	TIM1_ICInit(TIM1_CHANNEL_1, TIM1_ICPOLARITY_RISING, TIM1_ICSELECTION_DIRECTTI, TIM1_ICPSC_DIV1, 0);
 506  0166 4b00          	push	#0
 507  0168 4b00          	push	#0
 508  016a 4b01          	push	#1
 509  016c 5f            	clrw	x
 510  016d cd0000        	call	_TIM1_ICInit
 512  0170 5b03          	addw	sp,#3
 513                     ; 110 	TIM1_ICInit(TIM1_CHANNEL_2, TIM1_ICPOLARITY_FALLING, TIM1_ICSELECTION_INDIRECTTI, TIM1_ICPSC_DIV1, 0);	
 515  0172 4b00          	push	#0
 516  0174 4b00          	push	#0
 517  0176 4b02          	push	#2
 518  0178 ae0101        	ldw	x,#257
 519  017b cd0000        	call	_TIM1_ICInit
 521  017e 5b03          	addw	sp,#3
 522                     ; 112 	TIM1_SelectInputTrigger(TIM1_TS_TI1FP1);
 524  0180 a650          	ld	a,#80
 525  0182 cd0000        	call	_TIM1_SelectInputTrigger
 527                     ; 113 	TIM1_SelectSlaveMode(TIM1_SLAVEMODE_RESET);
 529  0185 a604          	ld	a,#4
 530  0187 cd0000        	call	_TIM1_SelectSlaveMode
 532                     ; 115 	TIM1_ClearFlag(TIM1_FLAG_CC2);
 534  018a ae0004        	ldw	x,#4
 535  018d cd0000        	call	_TIM1_ClearFlag
 537                     ; 116 	TIM1_ITConfig(TIM1_IT_CC2, ENABLE);	
 539  0190 ae0401        	ldw	x,#1025
 540  0193 cd0000        	call	_TIM1_ITConfig
 542                     ; 117 	TIM1_Cmd(ENABLE);
 544  0196 a601          	ld	a,#1
 545  0198 cd0000        	call	_TIM1_Cmd
 547                     ; 118 	enableInterrupts();
 550  019b 9a            rim
 552                     ; 119 }
 556  019c 81            	ret
 586                     ; 122 void TIM2_setup(void)
 586                     ; 123 {
 587                     	switch	.text
 588  019d               _TIM2_setup:
 592                     ; 124 	TIM2_DeInit();
 594  019d cd0000        	call	_TIM2_DeInit
 596                     ; 125 	TIM2_TimeBaseInit(TIM2_PRESCALER_32, 1250);
 598  01a0 ae04e2        	ldw	x,#1250
 599  01a3 89            	pushw	x
 600  01a4 a605          	ld	a,#5
 601  01a6 cd0000        	call	_TIM2_TimeBaseInit
 603  01a9 85            	popw	x
 604                     ; 126 	TIM2_OC1Init(TIM2_OCMODE_PWM2, TIM2_OUTPUTSTATE_ENABLE, 1000, TIM2_OCPOLARITY_LOW);
 ...
 613                     ; 127 	TIM2_OC2Init(TIM2_OCMODE_PWM2, TIM2_OUTPUTSTATE_ENABLE, 1000, TIM2_OCPOLARITY_LOW);
 ...
 721                     ; 134 void print_I(unsigned char x_pos, unsigned char y_pos, signed long value)
 721                     ; 135 {
 722                     	switch	.text
 723  01d8               _print_I:
 725  01d8 89            	pushw	x
 ...
 730                     ; 136 	char tmp[6] = {0x20, 0x20, 0x20, 0x20, 0x20, '\0'} ;
 ...
 738                     ; 138 	tmp[0] = ((value / 10000) + 0x30);
 ...
 753                     ; 139     tmp[1] = (((value / 1000) % 10) + 0x30);
 ...
 771                     ; 140 	tmp[2] = (((value / 100) % 10) + 0x30);
 ...
 789                     ; 141     tmp[3] = (((value / 10) % 10) + 0x30);
