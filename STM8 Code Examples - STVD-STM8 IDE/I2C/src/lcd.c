...
void LCD_GPIO_init(void)
{
	...
	GPIO_Init(LCD_PORT, LCD_RS, GPIO_MODE_OUT_PP_LOW_SLOW);
	GPIO_Init(LCD_PORT, LCD_EN, GPIO_MODE_OUT_PP_LOW_SLOW);
	GPIO_Init(LCD_PORT, LCD_DB4, GPIO_MODE_OUT_PP_LOW_SLOW);
	GPIO_Init(LCD_PORT, LCD_DB5, GPIO_MODE_OUT_PP_LOW_SLOW);
	GPIO_Init(LCD_PORT, LCD_DB6, GPIO_MODE_OUT_PP_LOW_SLOW);
	GPIO_Init(LCD_PORT, LCD_DB7, GPIO_MODE_OUT_PP_LOW_SLOW);
	delay_ms(10);    
}
