  ...
  58                     ; 7 	GPIO_Init(LCD_PORT, LCD_RS, GPIO_MODE_OUT_PP_LOW_SLOW);
  60  0006 4bc0          	push	#192
  61  0008 4b04          	push	#4
  62  000a ae500a        	ldw	x,#20490
  63  000d cd0000        	call	_GPIO_Init
  65  0010 85            	popw	x
  66                     ; 8 	GPIO_Init(LCD_PORT, LCD_EN, GPIO_MODE_OUT_PP_LOW_SLOW);
  68  0011 4bc0          	push	#192
  69  0013 4b08          	push	#8
  70  0015 ae500a        	ldw	x,#20490
  71  0018 cd0000        	call	_GPIO_Init
  73  001b 85            	popw	x
  74                     ; 9 	GPIO_Init(LCD_PORT, LCD_DB4, GPIO_MODE_OUT_PP_LOW_SLOW);
  76  001c 4bc0          	push	#192
  77  001e 4b10          	push	#16
  78  0020 ae500a        	ldw	x,#20490
  79  0023 cd0000        	call	_GPIO_Init
  81  0026 85            	popw	x
  82                     ; 10 	GPIO_Init(LCD_PORT, LCD_DB5, GPIO_MODE_OUT_PP_LOW_SLOW);
  84  0027 4bc0          	push	#192
  85  0029 4b20          	push	#32
  86  002b ae500a        	ldw	x,#20490
  87  002e cd0000        	call	_GPIO_Init
  89  0031 85            	popw	x
  90                     ; 11 	GPIO_Init(LCD_PORT, LCD_DB6, GPIO_MODE_OUT_PP_LOW_SLOW);
  92  0032 4bc0          	push	#192
  93  0034 4b40          	push	#64
  94  0036 ae500a        	ldw	x,#20490
  95  0039 cd0000        	call	_GPIO_Init
  97  003c 85            	popw	x
  98                     ; 12 	GPIO_Init(LCD_PORT, LCD_DB7, GPIO_MODE_OUT_PP_LOW_SLOW);
 100  003d 4bc0          	push	#192
