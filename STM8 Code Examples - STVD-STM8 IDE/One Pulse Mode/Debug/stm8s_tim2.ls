 ...
 483  006b c65308        	ld	a,21256
 484  006e a4fc          	and	a,#252
 485  0070 c75308        	ld	21256,a
 ...
 709  00cf c65309        	ld	a,21257
 710  00d2 a4fc          	and	a,#252
 711  00d4 c75309        	ld	21257,a
...
1430  01ca ca5301        	or	a,21249
1431  01cd c75301        	ld	21249,a
1433  01d0 2009          	jra	L565
1434  01d2               L365:
1435                     ; 382     TIM2->IER &= (uint8_t)(~TIM2_IT);
1437  01d2 7b01          	ld	a,(OFST+1,sp)
1438  01d4 43            	cpl	a
1439  01d5 c45301        	and	a,21249
1440  01d8 c75301        	ld	21249,a
1441  01db               L565:
1442                     ; 384 }
1445  01db 85            	popw	x
1446  01dc 81            	ret
...
1831  0211 c65305        	ld	a,21253
1832  0214 a48f          	and	a,#143
1833  0216 1a01          	or	a,(OFST+1,sp)
1834  0218 c75305        	ld	21253,a
1835                     ; 515 }
1838  021b 84            	pop	a
1839  021c 81            	ret
...
1887  021e c65306        	ld	a,21254
1888  0221 a48f          	and	a,#143
1889  0223 1a01          	or	a,(OFST+1,sp)
1890  0225 c75306        	ld	21254,a
1891                     ; 534 }
1894  0228 84            	pop	a
1895  0229 81            	ret
...
1943  022b c65307        	ld	a,21255
1944  022e a48f          	and	a,#143
1945  0230 1a01          	or	a,(OFST+1,sp)
1946  0232 c75307        	ld	21255,a
1947                     ; 553 }
1950  0235 84            	pop	a
1951  0236 81            	ret
...
2989  0341 c65305        	ld	a,21253
2990  0344 a4f3          	and	a,#243
2991  0346 1a01          	or	a,(OFST+1,sp)
2992  0348 c75305        	ld	21253,a
2993                     ; 928 }
2996  034b 84            	pop	a
2997  034c 81            	ret
...
3045  034e c65306        	ld	a,21254
3046  0351 a4f3          	and	a,#243
3047  0353 1a01          	or	a,(OFST+1,sp)
3048  0355 c75306        	ld	21254,a
3049                     ; 948 }
3052  0358 84            	pop	a
3053  0359 81            	ret
...
3101  035b c65307        	ld	a,21255
3102  035e a4f3          	and	a,#243
3103  0360 1a01          	or	a,(OFST+1,sp)
3104  0362 c75307        	ld	21255,a
3105                     ; 968 }
3108  0365 84            	pop	a
3109  0366 81            	ret
...
3757  0419 43            	cpl	a
3758  041a c75302        	ld	21250,a
3759                     ; 1110   TIM2->SR2 = (uint8_t)(~((uint8_t)((uint8_t)TIM2_FLAG >> 8)));
3761  041d 35ff5303      	mov	21251,#255
3762                     ; 1111 }
3765  0421 81            	ret
...
3997  044c 72115308      	bres	21256,#0
...
4008  045b c65305        	ld	a,21253
4009  045e a40c          	and	a,#12
4010  0460 1a01          	or	a,(OFST+0,sp)
4011  0462 c75305        	ld	21253,a
...
4096  047c 72195308      	bres	21256,#4
...
4107  048b c65306        	ld	a,21254
4108  048e a40c          	and	a,#12
4109  0490 1a01          	or	a,(OFST+0,sp)
4110  0492 c75306        	ld	21254,a
...
4195  04ac 72115309      	bres	21257,#0
...
4206  04bb c65307        	ld	a,21255
4207  04be a40c          	and	a,#12
4208  04c0 1a01          	or	a,(OFST+0,sp)
4209  04c2 c75307        	ld	21255,a
